...
\begin{itemize}
	\item 1. 每次运行时检查权限是否满足
	\item 2. 不满足权限要求时，要求用户授予权限
\end{itemize}
...
在测试时，我们选取了Android 4.4的系统进行了权限测试，Android 4.4系统在安装时进行了权限授权，并且通过卸载app之外的方式无法撤销，程序运行正常。如\autoref{fig:5-1-1}:
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_1_1.png}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_1_2.png}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_1_3_0.png}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_1_3_1.png}
		\caption{hdi显示测试}\label{fig:5-1-3-1}
	\end{figure}
...
\subsection{网络防护测试}
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{0.3\textwidth}            
			\frame{ \includegraphics[width=3cm\textwidth]{test_5_2_1_0.png}}
			\caption{Interpolation for Data 1}\label{fig:5_2_1_0}
		\end{subfigure}
%
\hspace{1cm}
%
		\begin{subfigure}[b]{0.3\textwidth}
			\centering
			\frame{\includegraphics[width=3cm]{test_5_2_1_1.png}}
			\caption{Interpolation for Data 2}\label{fig:5_2_1_1}
		\end{subfigure}
...
\end{figure}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_2_1_0.png}
		\caption{网络防护测试}\label{fig:5_2_1_0}
	\end{figure}
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_2_1_1.png}
		\caption{网络防护测试}\label{fig:5_2_1_1}
	\end{figure}
	
	
	\begin{figure}[!h]
		\includegraphics[width=0.5\textwidth]{test_5_2_1_2.png}
		\includegraphics[width=0.5\textwidth]{test_5_2_1_3.png}
		\caption{网络防护测试}\label{fig:5_2_1_2}
	\end{figure}
	...
	\begin{figure}[!h]
		\centering
		\caption{网络防护测试}\label{fig:5_2_1_3}
	\end{figure}
	
\subsection{文件防护测试}
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_2_2_0.png}
		\caption{文件防护测试}\label{fig:5_2_2_0}
	\end{figure}
	\begin{figure}[!h]
		\centering
		\includegraphics[width=1\textwidth]{test_5_2_2_1.png}
		\caption{文件防护测试}\label{fig:5_2_2_1}
	\end{figure}
